...
dist <- c(1/5, 1/5, 1/5, 1/5, 1/5)

teste3 <- replicate(10000, branching_process(dist, 1, 3))
teste10 <- replicate(10000, branching_process(dist, 1, 10))
...
cat("Intervalo de confiança para a probabilidade de extinção na terceira geração:", calcular_intervalo_de_confianca_media(teste3 == 0, 0.95))


cat("Intervalo de confiança para a probabilidade de extinção na décima geração:", calcular_intervalo_de_confianca_media(teste10 == 0, 0.95))
